defmodule LinkedinResponseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LinkedinResponseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LinkedinResponseWeb.Gettext, "errors", msg, opts)
    end
  end
